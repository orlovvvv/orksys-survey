...
export function BentoFeatures() {
	return (
		<Section
			background="white"
			className="relative overflow-hidden border-border border-y"
		>
			<SectionHeader
				label="Why Handshake?"
			...
			<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
				{/* Security Card */}
				<div className="group flex h-[520px] flex-col justify-between rounded-[40px] border border-border/60 bg-muted px-10 py-10 transition-all duration-500 hover:shadow-primary/5 hover:shadow-xl">
					<div>
						<div className="mb-8 flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10 text-primary">
							<ShieldCheck className="h-6 w-6" strokeWidth={1.5} />
						</div>
						<h3 className="mb-6 font-display font-normal text-2xl text-foreground leading-tight tracking-tight">
				...
				{/* Visual Card */}
				<div className="group relative h-[520px] overflow-hidden rounded-[40px] bg-foreground">
					...
					<div className="absolute bottom-10 left-10 pr-10 text-background">
				...
				<div className="group relative flex h-[520px] flex-col items-center justify-between overflow-hidden rounded-[40px] border border-border bg-muted px-10 py-10 shadow-sm">
					<div className="text-center">
						<span className="mb-2 block font-bold font-sans text-primary text-xs uppercase tracking-[0.2em]">
							Optimization
						</span>
						<span className="font-medium font-sans text-foreground text-xl">
							Completion Rate
						</span>
					</div>
					<div className="relative flex h-56 w-56 items-center justify-center">
						<div className="absolute inset-0 animate-pulse rounded-full bg-primary/5" />
						<div className="absolute inset-0 rounded-full border-[14px] border-border" />
						<svg
						...
						<div className="font-display font-normal text-5xl text-foreground tracking-tighter">
							94%
						</div>
					</div>
					<button className="w-full rounded-[20px] bg-foreground py-4 font-sans font-semibold text-background text-sm shadow-border shadow-lg transition-colors duration-300 hover:bg-primary">
						See Case Studies
					</button>
				</div>

				{/* AI Analysis Card */}
				<div className="relative flex h-[520px] flex-col justify-between rounded-[40px] bg-foreground p-10 text-background transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20">
					...
					<div className="space-y-6">
						<div className="group/link cursor-pointer">
							<p className="mb-1 font-sans text-background/50 text-xs uppercase tracking-widest">
								Processing Time
							</p>
							<p className="border-background/10 border-b pb-2 font-medium font-sans text-lg transition-colors group-hover/link:text-primary">
								Seconds, not days
							</p>
						</div>
						<div className="group/link cursor-pointer">
